...
public class RouteAnalyzer {
			...
			if (currentFile.isFile() && currentFile.getName().endsWith(".png")) {
				try {
					this.sprites.put(currentFile.getName().split("\\.")[0].toLowerCase(),
							Painting.toBufferedImage(ImageIO.read(currentFile).getScaledInstance(GameFrame.GRID_SIZE,
									GameFrame.GRID_SIZE, Image.SCALE_SMOOTH)));
				} catch (IOException e) {
					e.printStackTrace();
				}
			}
	...
	public void readRoute(File file) {
		/**
		 * TODO: Completely new Route saving. File format will be JSON. Height and
		 * weight wont be a parameter -> Dynamically calculated while reading the file
		 * Split the terrain and the sprite -> e.g.: "1.1":{"terrain":"snow",
		 * "sprite":"chair_up", "accessible":true, "pool":1, "encounterRate":0.1}
		 * 
		 * -> No "default" Terrain. Warps etc. will no longer be part of the Entity
		 * details -> Locations of special events will be declared in the details of
		 * this event (end of file)
		 * 
		 * 
		 * Add trainer movement -> Spinners -> Walking trainer
		 */
		for (int counter = 0; counter < 2; counter++) {
			...
			} catch (Exception | InvalidRouteDataException e) {
				e.printStackTrace();
				continue;
			}
			if (counter == 0) {
	...
	// currentRoute
	// .setDark(routeDetails.get("dark") != null ?
	// routeDetails.get("dark").getAsBoolean() : false);
	...
	// HashMap<String, ArrayList<Point>> events = new HashMap<String,
	// ArrayList<Point>>();
	...
	// break;
	// }
	// String currentString = routeDetails.get(x + "." +
	// y).getAsString().toUpperCase();
	// if (!currentString.startsWith("W") && !currentString.startsWith("PKM")
	// && !currentString.startsWith("TRIGGERED") &&
	...
	// break;
	// case "TV":
	// currentEntity = new Entity(currentRoute, false, "tv", 0,
	// currentRoute.getTerrainName());
	// break;
	// case "LAPTOP":
	...
	// break;
	// case "FR":
	// currentEntity = new Entity(currentRoute, false, "fridge", 0,
	// currentRoute.getTerrainName());
	// break;
	// case "SV":
	// currentEntity = new Entity(currentRoute, false, "server", 0,
	// currentRoute.getTerrainName());
	// break;
	// case "V":
	// currentEntity = new Entity(currentRoute, false, "vitrine", 0,
	// currentRoute.getTerrainName());
	// break;
	// case "BS":
	...
	// break;
	// case "TL":
	// currentEntity = new Entity(currentRoute, false, "toilette", 0,
	// currentRoute.getTerrainName());
	// break;
	// case "BT":
	// currentEntity = new Entity(currentRoute, false, "bathtub", 0,
	// currentRoute.getTerrainName());
	// break;
	// case "STUHLR":
	// currentEntity = new Entity(currentRoute, true, "chair_r",
	// nonGrassEncounterRate,
	// currentRoute.getTerrainName());
	// break;
	// case "STUHLL":
	// currentEntity = new Entity(currentRoute, true, "chair_l",
	// nonGrassEncounterRate,
	// currentRoute.getTerrainName());
	// break;
	// case "STUHLD":
	// currentEntity = new Entity(currentRoute, true, "chair_d",
	// nonGrassEncounterRate,
	// currentRoute.getTerrainName());
	// break;
	// case "STUHLU":
	// currentEntity = new Entity(currentRoute, true, "chair_u",
	// nonGrassEncounterRate,
	// currentRoute.getTerrainName());
	// currentRoute.addBuilding("chair_u", new Point(x, y));
	// break;
	// case "SETTLER":
	// currentEntity = new Entity(currentRoute, true, "settle_r",
	// nonGrassEncounterRate,
	// currentRoute.getTerrainName());
	// break;
	// case "SETTLEL":
	// currentEntity = new Entity(currentRoute, true, "settle_l",
	// nonGrassEncounterRate,
	// currentRoute.getTerrainName());
	// break;
	// case "SETTLED":
	// currentEntity = new Entity(currentRoute, true, "settle_d",
	// nonGrassEncounterRate,
	// currentRoute.getTerrainName());
	// break;
	// case "SETTLEU":
	// currentEntity = new Entity(currentRoute, true, "settle_u",
	// nonGrassEncounterRate,
	// currentRoute.getTerrainName());
	// break;
	// case "F": // Free
	...
	// break;
	// case "B": // Bridge
	// currentEntity = new Entity(currentRoute, true, "bridge",
	// nonGrassEncounterRate,
	// currentRoute.getTerrainName());
	// break;
	// case "LKWR":
	// currentEntity = new Entity(currentRoute, false, "lkw_right",
	// nonGrassEncounterRate,
	// "stone");
	// currentRoute.addBuilding("lkw_right", new Point(x, y));
	// break;
	// case "LKWL":
	// currentEntity = new Entity(currentRoute, false, "lkw_left",
	// nonGrassEncounterRate,
	// "stone");
	// currentRoute.addBuilding("lkw_left", new Point(x, y));
	// break;
	// case "PC":
	// currentEntity = new Entity(currentRoute, false, "pc", 0,
	// currentRoute.getTerrainName());
	// break;
	// case "STATUE":
	// currentEntity = new Entity(currentRoute, false, "statue", 0,
	// currentRoute.getTerrainName());
	// break;
	// case "JH":
	...
	// break;
	// case "HWLF":
	// currentEntity = new Entity(currentRoute, false,
	// "cave_left_front_corner_outside", 0,
	// currentRoute.getTerrainName());
	// break;
	// case "HWLB":
	// currentEntity = new Entity(currentRoute, false,
	// "cave_left_back_corner_outside", 0,
	// currentRoute.getTerrainName());
	// break;
	// case "HWRB":
	// currentEntity = new Entity(currentRoute, false,
	// "cave_right_back_corner_outside", 0,
	// currentRoute.getTerrainName());
	// break;
	// case "HWRF":
	// currentEntity = new Entity(currentRoute, false,
	// "cave_right_front_corner_outside", 0,
	// currentRoute.getTerrainName());
	// break;
	// case "HWRBI":
	// currentEntity = new Entity(currentRoute, false,
	// "cave_right_back_corner_inside", 0,
	// currentRoute.getTerrainName());
	// break;
	// case "HWRFI":
	// currentEntity = new Entity(currentRoute, false,
	// "cave_right_front_corner_inside", 0,
	// currentRoute.getTerrainName());
	// break;
	// case "HWLBI":
	// currentEntity = new Entity(currentRoute, false,
	// "cave_left_back_corner_inside", 0,
	// currentRoute.getTerrainName());
	// break;
	// case "HWLFI":
	// currentEntity = new Entity(currentRoute, false,
	// "cave_left_front_corner_inside", 0,
	// currentRoute.getTerrainName());
	// break;
	// case "HM":
	// currentEntity = new Entity(currentRoute, true, "cave_middle",
	// nonGrassEncounterRate,
	// currentRoute.getTerrainName());
	// break;
	// case "SCF":
	// currentEntity = new Entity(currentRoute, false, false, true, true,
	// "stairway_front",
	...
	// break;
	// case "ZF":
	// currentEntity = new Entity(currentRoute, false, "zaun_front",
	// nonGrassEncounterRate,
	// currentRoute.getTerrainName());
	// break;
	// case "ZL":
	// currentEntity = new Entity(currentRoute, false, "zaun_links",
	// nonGrassEncounterRate,
	// currentRoute.getTerrainName());
	// break;
	// case "ZR":
	// currentEntity = new Entity(currentRoute, false, "zaun_rechts",
	// nonGrassEncounterRate,
	// currentRoute.getTerrainName());
	// break;
	// case "RB":
	...
	// break;
	// case "R":
	// currentEntity = new Entity(currentRoute, false, "rock",
	// nonGrassEncounterRate,
	// currentRoute.getTerrainName());
	// break;
	// case "IR":
	// currentEntity = new Entity(currentRoute, false, "icerock",
	// nonGrassEncounterRate,
	// "snow");
	// break;
	// case "IP":
	// currentEntity = new Entity(currentRoute, false, "icepillar",
	// nonGrassEncounterRate,
	// "snow");
	// break;
	// case "IRB":
	// currentEntity = new Entity(currentRoute, false, "icerockbig",
	// nonGrassEncounterRate,
	// "snow");
	// break;
	// case "TC":
	// currentEntity = new Entity(currentRoute, false, "treecut",
	// nonGrassEncounterRate,
	// currentRoute.getTerrainName());
	// break;
	// case "ST":
	...
	// break;
	// case "GENERATOR":
	// currentEntity = new GeneratorEntity(currentRoute,
	// currentRoute.getTerrainName());
	// break;
	// case "HOOK":
	// currentEntity = new Entity(currentRoute, false, "hook",
	// nonGrassEncounterRate,
	// currentRoute.getTerrainName());
	// break;
	// default:
	...
	// currentEntity = new Entity(currentRoute, false, false, false, true, "free",
	// 0, "free");
	...
	// currentEntity = new PokemonEntity(currentRoute,
	// currentRoute.getTerrainName(),
	// currentString);
	// pokemons.add((PokemonEntity) currentEntity);
	// } else if (currentString.startsWith("TRIGGERED")) {
	// currentEntity = new Entity(currentRoute, true, "free", 0,
	// currentRoute.getTerrainName());
	...
	// currentEntity = new ItemEntity(currentRoute, currentRoute.getTerrainName(),
	// currentString,
	// false);
	// items.add((ItemEntity) currentEntity);
	// } else if (currentString.startsWith("GRASS")) {
	// if(currentString.contains("SNOW")) {
	// currentEntity = new Entity(currentRoute, true, "snow_grass",
	...
	// currentEntity = new QuestionEntity(currentString, currentRoute,
	// currentRoute.getTerrainName());
	...
	// currentCharacter
	// .setLogo(currentChar.get("logo") != null ?
	// currentChar.get("logo").getAsString() : null);
	...
	// currentChar.get("aggro") != null ? currentChar.get("aggro").getAsBoolean() :
	// true);
	...
	// }
	// }
	// for (int i = 0; i < Math.min(hatchesDetails.size(), currentHatches.size());
	// i++) {
	...
	// entity.addGenerator(
	// generator.get("route") != null ? generator.get("route").getAsString() :
	// routeID,
	// new Point(generator.get("x").getAsInt(), generator.get("y").getAsInt()));
	// }
	//
	// entity.setMinimum(
	// currentHatch.get("minimum") != null ? currentHatch.get("minimum").getAsInt()
	// : 0);
	//
	// }
	// }
	...
	// JsonArray currentEvent =
	// eventDetails.get(event.toLowerCase()).getAsJsonArray();
	...
	// currentChange.setFight(j.get("fight") != null ? j.get("fight").getAsBoolean()
	// : false);
	...
	// j.get("sprite_update") != null ? j.get("sprite_update").getAsString() :
	// null);
	// currentChange.setHeal(j.get("heal") != null ? j.get("heal").getAsBoolean() :
	// false);
	// currentChange.setRemove(j.get("remove") != null ?
	// j.get("remove").getAsBoolean() : false);
	...
	// j.get("cam_animation") != null ? j.get("cam_animation").getAsBoolean() :
	// false);
	// currentChange.setCenterCharacter(
	// j.get("cam_center") != null ? j.get("cam_center").getAsBoolean() : false);
	// currentChange.setSound(j.get("sound") != null ? j.get("sound").getAsString()
	// : null);
	// currentChange.setWait(j.get("wait") != null ? j.get("wait").getAsBoolean() :
	// true);
	// currentChange.setDelay(j.get("delay") != null ? j.get("delay").getAsLong() :
	// 0);
	// currentChange.setUnknown(j.get("unknown") != null ?
	// j.get("unknown").getAsBoolean() : false);
	// currentChange.setPause(j.get("pause") != null ? j.get("pause").getAsBoolean()
	// : false);
	...
	// JsonObject currentQuiz =
	// quizData.get(q.getID().toUpperCase()).getAsJsonObject();
	...
	// currentQuiz.get("source").getAsString() :
	// "nothing");
	...
	// q.addGates(currentRoute.getEntity(entity.get("x").getAsInt(),
	// entity.get("y").getAsInt()));
	// }
	// }
	// }
	// }
	...
	public boolean saveGame(String saveName) {
		try {
			...
			charData.add(this.gController.getMainCharacter().getSaveData());
			...
			for (String s : this.loadedRoutes.keySet()) {
				if (!this.loadedRoutes.get(s).equals(this.originalRoutes.get(s), false)) {
					routeData.add(this.loadedRoutes.get(s).getSaveData(this.originalRoutes.get(s)));
				}
			}
	...
	public boolean loadGame(String path) {
		try {
			...
			this.gController.getMainCharacter().importSaveData(characters.get(0).getAsJsonObject());
			for (Route currentRoute : this.loadedRoutes.values()) {
			...
			for (JsonElement current : routes) {
				...
				route.importSaveData(currentJson, this.originalRoutes.get(route.getId()));
			}
	...
	public void updateHatches(GeneratorEntity source) {
		for (HatchEntity hatch : this.hatches) {
